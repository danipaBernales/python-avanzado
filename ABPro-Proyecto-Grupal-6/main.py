...
class Vendedor():
    ...
    def vender(self, producto, cliente):
        try:
            ...
            return str(e)  # Devolver el mensaje de la excepción personalizada
...
# Función para cargar los datos de los proveedores desde el archivo serializado
...
# Función para guardar los datos de los proveedores en el archivo serializado
...
clientes = []
vendedores = []
proveedores = cargar_proveedores()  # Cargar los proveedores al inicio del programa
