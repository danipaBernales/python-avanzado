...
def manejar_errores():
    try:
        # Intentar ejecutar el código propenso a errores
        main()
    except IndexError as e:
        print(f"Error de índice: {e}. Asegúrese de que los índices estén dentro de los límites de la lista.")
    except TypeError as e:
        print(f"Error de tipo: {e}. Verifique que los tipos de datos sean compatibles.")
    except KeyError as e:
        print(f"Error de clave: {e}. Asegúrese de que la clave exista en el diccionario.")
    finally:
        print("Se ejecutó el bloque finally. ¡Manejo de errores completado!")

# Llamada a la función para manejar errores
manejar_errores()

"""
Manejar los errores en la programación es esencial por varias razones:

Robustez del programa: El manejo de errores permite que un programa continúe ejecutándose incluso si se encuentran situaciones inesperadas o errores durante la ejecución. Esto aumenta la robustez del programa y evita que se bloquee o se detenga abruptamente.

Identificación y depuración de problemas: Al manejar los errores de manera adecuada, se pueden identificar y diagnosticar los problemas de manera más rápida y eficiente. Los mensajes de error proporcionados por los bloques try-except ayudan a entender qué salió mal y dónde ocurrió el error en el código.

Mejora de la experiencia del usuario: Cuando un programa maneja los errores de manera adecuada, proporciona una experiencia más fluida al usuario. En lugar de mostrar mensajes de error crípticos o bloquearse inesperadamente, el programa puede informar al usuario sobre los problemas de manera clara y concisa, lo que facilita su comprensión y resolución.

Prevención de fallos catastróficos: Al anticipar y manejar los errores, se pueden prevenir fallos catastróficos que podrían resultar en la pérdida de datos importantes o en un comportamiento no deseado del programa. Esto es especialmente importante en aplicaciones críticas o sensibles donde la integridad de los datos es fundamental.

Mejora de la calidad del código: El manejo de errores fomenta una programación defensiva, donde se escriben programas que pueden manejar una variedad de situaciones y condiciones. Esto conduce a un código más robusto, mantenible y de mejor calidad en general.

En resumen, el manejo de errores es fundamental para desarrollar programas confiables, estables y fáciles de mantener, y es una práctica esencial en el desarrollo de software.
"""